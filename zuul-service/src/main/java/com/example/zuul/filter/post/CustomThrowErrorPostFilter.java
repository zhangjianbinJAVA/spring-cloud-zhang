...
@Slf4j
@Component
public class CustomThrowErrorPostFilter extends ZuulFilter {
    @Override
    public String filterType() {
        return CustomFilter.CustomThrowErrorPostFilter.getFilterType();
    }

    @Override
    public int filterOrder() {
        return CustomFilter.CustomThrowErrorPostFilter.getFilterOrder();
    }
